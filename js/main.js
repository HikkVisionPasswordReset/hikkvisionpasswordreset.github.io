...
function pieChart() {
	...
	if ((jQuery().easyPieChart) && (jQuery.support.leadingWhitespace)) {
		var count = 0 ;
		var colors = ['#E8A115', '#FF0000', '#400CE8', '#0DFFF7'];
		//var colors = ['#1971aa'];
...
jQuery(document).ready(function() {
	...
	//parallax
	if (jQuery().parallax) {
		jQuery('#testimonials').parallax("50%", 0.045);
		jQuery('#some-fact').parallax("50%", 0.045);
		jQuery('#skills').parallax("50%", 0.045);
		jQuery('#footer').parallax("50%", 0.045);
		jQuery('#contact').parallax("50%", 0.045);
	}
